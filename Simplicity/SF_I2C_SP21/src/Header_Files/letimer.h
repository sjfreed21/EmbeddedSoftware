...
#define LETIMER_EM		EM4				// Utilizing ULFRCO, block from entering EM4
...
typedef struct {
	...
	bool			comp0_irq_enable;	// enable interrupt comp0
	uint32_t		comp0_cb;
	bool			comp1_irq_enable;	// enable interrupt comp1
	uint32_t		comp1_cb;
	bool			uf_irq_enable;		// enable interrupt uf
	uint32_t		uf_cb;
