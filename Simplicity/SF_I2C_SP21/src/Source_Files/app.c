...
/********************************************//**
 * @brief
 *	The scheduler program to handle I2C interrupts.
 *
 * @details
 *	This function currently toggles LED1 based on the value output by the SI7021.
 *
 * @note
...
void scheduled_si7021_read_cb(void) {
	...
	if(val >= 40.0) GPIO_PinModeSet(LED1_PORT, LED1_PIN, LED1_GPIOMODE, true);
